...
- **Versión:** 0.10 (sobre v0.0.137 — añade el **motor de rondas fase 1**: inicio del san con sorteo de turnos en tres modos —manual con arrastre, aleatorio y ruleta animada con sonido—, aprobación de pagos con declaración + PIN, congelado del equivalente en $ y fecha real del pago en cada aporte, invitación por correo o @usuario, página de Términos (maqueta), confirmación de cierre de sesión y varios pulidos de seguridad. Construido sobre la base de v0.0.117 —invitación temporal con solicitud de unión, portero de verificación KYC + confirmación con PIN al unirse, pestaña Miembros y Pagos simplificada—. Detalle en `CHANGELOG.md` (`[0.0.137]` y `[0.0.117]`) y en `docs/superpowers/specs/2026-06-03-motor-rondas-san-design.md` + `docs/superpowers/specs/2026-06-03-invitacion-miembros-pagos-design.md`)
- **Fecha:** 2026-06-04
