...
## 0. Estado del proyecto (sesión 2026-06-02, sobre v0.0.70–v0.0.94)

Foto rápida de qué funciona, qué falta y qué se decidió en las últimas sesiones.
**Hitos de esta sesión:** rediseño completo del modelo de autenticación con PIN estilo Cashea, nueva gestión de usuarios en el panel super-admin, planificador de tasas mejorado, etiquetas de monedas actualizadas (USDT → USDC / paralelo → promedio), guía de monedas fiat vs cripto, y favicon con el logo de Green Sol.
