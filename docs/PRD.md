...
- **Versión:** 0.15 (núcleo del MVP **construido y verificado** + **KYC propio completo** + **modelo de auth con PIN como credencial** rediseñado al estilo Cashea + **gestión de usuarios en el panel admin** completa + **planificador de tasas** actualizado + **guía de monedas fiat vs cripto** + **favicon de marca** + **aislamiento E2E** + **detalle del san rediseñado: pestañas Resumen/Pagos**, vistas por rol, conversión Bs↔$ y notificaciones completas del san, app v0.0.106). Estado de desarrollo en [CHANGELOG.md](../CHANGELOG.md); diseño en [superpowers/specs/2026-05-29-green-sol-mvp-design.md](superpowers/specs/2026-05-29-green-sol-mvp-design.md), [superpowers/specs/2026-05-31-kyc-verificacion-identidad-design.md](superpowers/specs/2026-05-31-kyc-verificacion-identidad-design.md) y [superpowers/specs/2026-06-02-detalle-san-pagos-design.md](superpowers/specs/2026-06-02-detalle-san-pagos-design.md).
- **Fecha:** 2026-06-02
...
> **Próximo foco acordado:** ✅ **flujo del san mejorado de punta a punta** (completado — v0.0.99–v0.0.106). Siguiente: **integración cripto** (DevNet) y factores de **seguridad** restantes.
